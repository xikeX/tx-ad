...
from my_dataset_v1_aug_hard import BaseDataset, TrainDataset, ValidDataset
...
def get_args():
    ...
    parser.add_argument('--train_name', type=str, default="v6-infonce-hard", help='训练名称')
...
def train_downstream_model(model, train_dataset, valid_loader, args, writer, test_dataset=None, test_dataset_2=None):
    ...
    for epoch in range(1, args.num_epochs + 1):
        ...
        if test_dataset:
            ...
            writer.add_scalar('HitRat/eval_distance', distance, global_step)
...
def main():
    ...
    # 模型训练
    train_downstream_model(downstream_model, train_dataset, valid_loader, args, writer, valid_dataset_valid, train_dataset_valid)
