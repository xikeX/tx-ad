...
from baseline_model_v3_infonce_e32_h64 import BaselineModel
...
def main():
    ...
    user_list = []
    torch.save(downstream_model.state_dict(), 'mb.pth')
    print("评估开始")
    eval_candidate_path = os.path.join(os.environ['USER_CACHE_PATH'], 'item_feat_dict_train.json')
    infer = Infer(args, downstream_model, eval_dataset=test_dataset, candidate_path=eval_candidate_path,name='2',query_ann_top_k=10)
