...
# from my_dataset_v1_copy import TrainDataset, ValidDataset,BaseDataset
...
def get_args():
    ...
    # ================== 训练优化参数 ==================
    parser.add_argument('--num_epochs', type=int, default=30, help='训练总轮数')
...
def main():
    ...
    # 模型训练
    train_downstream_model(downstream_model, train_loader, valid_loader, args, writer, valid_dataset_valid, train_dataset_valid)
